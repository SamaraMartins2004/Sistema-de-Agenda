...
export async function logar(dados) {
    //try carch serve para qd precisamos fazer uma função. Ela vai tentar executar o solicitado
    //não conseguindo, vai retornar com alguma mensagem
    //lembrando que o "e" serve para que qd obtiver um retorno, não "envie" a respostas, pois será tratada no cliente
    try {
